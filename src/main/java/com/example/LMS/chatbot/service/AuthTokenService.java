...
public class AuthTokenService {
    ...
    public String extractSessionIdFromAccess(String token) {
        return extractSessionIdByType(token, "access");
    }

    public String extractSessionIdFromRefresh(String token) {
        return extractSessionIdByType(token, "refresh");
    }
    ...
    public String createAccessToken(String sessionId, long expiresAtEpochSeconds) {
        return createTypedToken(sessionId, expiresAtEpochSeconds, "access");
    }

    public String createRefreshToken(String sessionId, long expiresAtEpochSeconds) {
        return createTypedToken(sessionId, expiresAtEpochSeconds, "refresh");
    }

    private String createTypedToken(String sessionId, long expiresAtEpochSeconds, String type) {
    ...
    private String extractSessionIdByType(String token, String requiredType) {
        ...
        String typ = payload.path("typ").asText("access");
